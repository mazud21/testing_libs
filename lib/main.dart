...
void onStart(ServiceInstance service) async {
  ...
  // Timer to call getLocation every 5 seconds
  Timer.periodic(const Duration(seconds: 5), (timer) async {
    ...
    String location = await getLocation();  // Await the Future to get the result
    debugPrint('FLUTTER BACKGROUND SERVICE: $location ${DateTime.now()}');

    // Test using external plugin for device information
...
// Modify the getLocation function to ensure continuous location updates
getLocation() async {
